...
Class Experiment {
    ...
    private $languageFields; use \Karolina\Language\LanguageTrait;
    private $customLanguageFields; use \Karolina\Language\CustomLanguageTrait;
    private $team; use \Karolina\Team\TeamTrait;
